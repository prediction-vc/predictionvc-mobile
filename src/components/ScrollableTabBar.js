...
export class ScrollableTabBar extends Component {
  static propTypes = {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      _widthTabUnderline: new Animated.Value(84),
  ...
  onScrollNext = () => {
    this._scrollView.scrollTo({x: WINDOW_WIDTH - 45});
  };
  ...
  render() {
    ...
    >
      ...
      <ImageButton
        ...
        style={styles.scrollNextButton}
        onPress={this.onScrollNext}
      />
    </View>;
  }
